...
<>
  ...
  <div className="md:mt-14 mt-4 relative sm:flex items-center justify-center">
    ...
    />
    <div className="shadow-lg xl:p-6 p-4 sm:w-auto w-full bg-blue-100 rounded-lg sm:absolute relative z-20  mt-4 left-0 xl:ml-56 sm:ml-12 xl:-mt-40 sm:-mt-12">
    ...
    <div className="shadow-lg xl:p-6 p-4  sm:w-auto w-full bg-blue-100 rounded-lg sm:absolute relative z-20 mt-4 xl:mt-80 sm:mt-56 xl:-ml-0 sm:-ml-12">
      <p className="text-3xl font-semibold text-gray-800">8K+</p>
      <p className="text-base leading-4 xl:mt-4 mt-2 text-gray-600">
        Active Listening
      </p>
    </div>
    <div className="shadow-lg xl:p-6 p-4 sm:w-auto w-full bg-blue-100 rounded-lg sm:absolute relative z-20 md:mt-0 sm:-mt-5 mt-4 right-0 xl:mr-56 sm:mr-24">
